...
def BB_sudoku4(S, D, C):
    ...
    # Call advanced sudoku function with matrix size of 9
...
def main():
    ...
    #S = [["3","2","4","0"],["0","1","3","2"],["0","0","2","0"],["2","4","0","3"]] # Example for formate when size = 4
    print_sudoku(S, size=9)
    # Run BB_sudoku on puzzle S
    R = BB_sudoku4(S, D=difficulty, C=approach)

    print_sudoku(R, size=9)
